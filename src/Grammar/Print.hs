...
instance Print (Grammar.Abs.Program' a) where
  prt i = \case
    Grammar.Abs.Program _ progcomps -> prPrec i 0 (concatD [prt 0 progcomps])

instance Print [Grammar.Abs.ProgComp' a] where
  prt _ [] = concatD []
...
instance Print (Grammar.Abs.ProgComp' a) where
  prt i = \case
    Grammar.Abs.FunDecl _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    Grammar.Abs.VarDecl _ type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])

instance Print (Grammar.Abs.Arg' a) where
  prt i = \case
    Grammar.Abs.ValArg _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_])
    Grammar.Abs.RefArg _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "@"), prt 0 id_])
...
instance Print (Grammar.Abs.Item' a) where
  prt i = \case
    Grammar.Abs.NoInit _ id_ -> prPrec i 0 (concatD [prt 0 id_])
    Grammar.Abs.Init _ id_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 expr])
...
instance Print (Grammar.Abs.Block' a) where
  prt i = \case
    Grammar.Abs.Block _ stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, doc (showString "}")])
...
instance Print (Grammar.Abs.Stmt' a) where
  prt i = \case
    Grammar.Abs.Empty _ -> prPrec i 0 (concatD [doc (showString "pass"), doc (showString ";")])
    Grammar.Abs.StmtBlock _ block -> prPrec i 0 (concatD [prt 0 block])
    Grammar.Abs.StmtComp _ progcomp -> prPrec i 0 (concatD [prt 0 progcomp])
    Grammar.Abs.Assign _ id_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])
    ...
    Grammar.Abs.IfElse _ expr block1 block2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block1, doc (showString "else"), prt 0 block2])
    Grammar.Abs.While _ expr block -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
...
instance Print (Grammar.Abs.Expr' a) where
  prt i = \case
    ...
    Grammar.Abs.ELambda _ args type_ block -> prPrec i 0 (concatD [doc (showString "\\"), doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "->"), prt 0 type_, doc (showString "=>"), prt 0 block])
    Grammar.Abs.EApplic _ id_ exprs -> prPrec i 6 (concatD [prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
...
instance Print (Grammar.Abs.RelOp' a) where
  prt i = \case
    Grammar.Abs.Less _ -> prPrec i 0 (concatD [doc (showString "<")])
    Grammar.Abs.LEQ _ -> prPrec i 0 (concatD [doc (showString "<=")])
    Grammar.Abs.Greater _ -> prPrec i 0 (concatD [doc (showString ">")])
    Grammar.Abs.GEQ _ -> prPrec i 0 (concatD [doc (showString ">=")])
    Grammar.Abs.EQU _ -> prPrec i 0 (concatD [doc (showString "==")])
    Grammar.Abs.NEQ _ -> prPrec i 0 (concatD [doc (showString "!=")])
